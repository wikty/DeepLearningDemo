...
class ExperimentCfg(object):
    ...
    def __init__(self, experiment_dir,
        ...
        self.set_experiment_dir(experiment_dir)
    ...
    def checkpoint_filename(self, checkpoint=None):
        if checkpoint is None:
            return self._checkpoint_file
        return self._checkpoint_file.format(checkpoint=checkpoint)

    def metrics_filename(self, checkpoint=None, dataset=None):
        if checkpoint is None or dataset is None:
            return self._metrics_file
        return self._metrics_file.format(checkpoint=checkpoint,
                                         dataset=dataset)

    def train_logname(self):
        return self._train_log

    def evaluate_logname(self):
        return self._evaluate_log
